 ...
 * interface for working with transaction metadata in JDK 1.5+ annotation
 * format.
 *
 * <p>
 * This class reads Spring's JDK 1.5+ {@link Transactional} annotation and
 * exposes corresponding transaction attributes to Spring's transaction
 * infrastructure. Also supports JTA 1.2's
 * {@link javax.transaction.Transactional} and EJB3's
 * {@link javax.ejb.TransactionAttribute} annotation (if present). This class
 * may also serve as base class for a custom TransactionAttributeSource, or get
...
public class AnnotationTransactionAttributeSource extends AbstractFallbackTransactionAttributeSource
	...
	/**
	 * Create a default AnnotationTransactionAttributeSource, supporting public
	...
	/**
	 * Create a custom AnnotationTransactionAttributeSource, supporting public
	 * methods that carry the {@code Transactional} annotation or the EJB3
	 * {@link javax.ejb.TransactionAttribute} annotation.
	 * 
	 * @param publicMethodsOnly
	 *            whether to support public methods that carry the
	 *            {@code Transactional} annotation only (typically for use with
	 *            proxy-based AOP), or protected/private methods as well
	 ...
	 * {@link TransactionAnnotationParser TransactionAnnotationParsers} for
	 * parsing known annotations into Spring's metadata attribute class. Returns
	 * {@code null} if it's not transactional.
	 * <p>
	 ...
	 * @return the configured transaction attribute, or {@code null} if none was
	 *         found
	 */
	@Nullable
