 ...
 * {@link org.springframework.transaction.TransactionStatus} interface, used by
 * {@link AbstractPlatformTransactionManager}. Based on the concept of an
 ...
 *
 * <p>
 * Supports delegating savepoint-related methods to a transaction object that
 * implements the {@link SavepointManager} interface.
 *
 * <p>
 * <b>NOTE:</b> This is <i>not</i> intended for use with other
 * PlatformTransactionManager implementations, in particular not for mock
 * transaction managers in testing environments. Use the alternative
 * {@link SimpleTransactionStatus} class or a mock for the plain
...
public class DefaultTransactionStatus extends AbstractTransactionStatus {
	 ...
	 *            if the transaction is new, otherwise participating in an
	 ...
	 * by {@link AbstractPlatformTransactionManager} as an optimization, to
	 * prevent repeated calls to {@code logger.isDebugEnabled()}. Not really
	 * intended for client code.
	 */
	...
	/**
	 * Determine the rollback-only flag via checking the transaction object,
	 * provided that the latter implements the {@link SmartTransactionObject}
	 * interface.
	 * <p>
	 * Will return {@code true} if the global transaction itself has been marked
	 * rollback-only by the transaction coordinator, for example in case of a
	 * timeout.
	 * 
	 ...
	 * {@link SavepointManager} interface and therefore supports savepoints.
	 * 
	 * @see #getTransaction()
