...
class ConstructorResolver {
	...
	public BeanWrapper autowireConstructor(String beanName, RootBeanDefinition mbd,
		...
		if (constructorToUse == null || argsToUse == null) {
			...
			/*
			 * explicitArgs 当你调用getBean()的时候给定的构造参数
		...
		if (factoryMethodToUse == null || argsToUse == null) {
			...
			for (Method candidate : candidates) {
				...
				if (paramTypes.length >= minNrOfArgs) {
					...
					// Find out about ambiguity: In case of the same type
					// difference weight
					// for methods with the same number of parameters, collect
					// such candidates
					// and eventually raise an ambiguity exception.
					// However, only perform that check in non-lenient
					// constructor resolution mode,
					// and explicitly ignore overridden methods (with the same
					// parameter signature).
	 ...
	 * <p>
	 * This method is also used for handling invocations of static factory
	 * methods.
	 */
	...
	private ArgumentsHolder createArgumentArray(String beanName, RootBeanDefinition mbd,
		...
		for (int paramIndex = 0; paramIndex < paramTypes.length; paramIndex++) {
			...
			if (resolvedValues != null) {
				...
				// autowire,
				// let's try the next generic, untyped argument value as
				// fallback:
