...
final class JdkDynamicAopProxy implements AopProxy, InvocationHandler, Serializable {
	...
	/*
	 * NOTE: We could avoid the code duplication between this class and the
	 * CGLIB proxies by refactoring "invoke" into a template method. However,
	 * this approach adds at least 10% performance overhead versus a copy-paste
	 * solution, so we sacrifice elegance for performance. (We have a good test
	 * suite to ensure that the different proxies behave the same :-) This way,
	 * we can also more easily take advantage of minor optimizations in each
	 * class.
	 */
	...
	public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
		...
		try {
			...
			// 前面创建代理是是判断的类对象要不要增强：类匹配、类中有方法匹配pointcut
