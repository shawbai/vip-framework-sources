 ...
 * classes honoring the AspectJ 5 annotation syntax, using reflection to invoke
 * the corresponding advice methods.
 *
 * @author Rod Johnson
...
public class ReflectiveAspectJAdvisorFactory extends AbstractAspectJAdvisorFactory implements Serializable {
	...
	static {
		Comparator<Method> adviceKindComparator = new ConvertingComparator<>(new InstanceComparator<>(Around.class,
				...
				(Converter<Method, Annotation>) method -> {
					AspectJAnnotation<?> annotation = AbstractAspectJAdvisorFactory
	...
	/**
	 * Create a new {@code ReflectiveAspectJAdvisorFactory}, propagating the
	 * given {@link BeanFactory} to the created
	 * {@link AspectJExpressionPointcut} instances, for bean pointcut handling
	 * as well as consistent {@link ClassLoader} resolution.
	 * 
	 * @param beanFactory
	...
	/**
	 * Build a {@link org.springframework.aop.aspectj.DeclareParentsAdvisor} for
	 * the given introduction field.
	 * <p>
	...
	/**
	 * Synthetic advisor that instantiates the aspect. Triggered by per-clause
	 * pointcut on non-singleton aspect. The advice has no effect.
	 */
	@SuppressWarnings("serial")
