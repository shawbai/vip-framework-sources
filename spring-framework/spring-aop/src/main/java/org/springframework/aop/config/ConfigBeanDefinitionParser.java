...
class ConfigBeanDefinitionParser implements BeanDefinitionParser {
	 ...
	 * {@link BeanDefinition BeanDefinitions} created by the
	 * '{@code <aop:config/>}' tag. Will force class proxying if the
	...
	/**
	 * Create a {@link RootBeanDefinition} for the advisor described in the
	 * supplied. Does <strong>not</strong> parse any associated
	 * '{@code pointcut}' or '{@code pointcut-ref}' attributes.
	 */
	...
	/**
	 * Parses one of '{@code before}', '{@code after}',
	 * '{@code after-returning}', '{@code after-throwing}' or '{@code around}'
	 * and registers the resulting BeanDefinition with the supplied
